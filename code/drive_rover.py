...
class RoverState():
    def __init__(self):
        ...
        self.stop_forward = 170 # Threshold to initiate stopping
        ...
        self.rock_dist = None
        self.home_pos = None  # Save starting position as home
        self.position_memory = []  # Memory of recent positions to detect being stuck
        self.path_history = []  # History of all positions for path tracking
        self.backtrack_path = None # Path to backtrack to home
        self.percentage_mapped = 0 # Percentage of worldmap that is mapped
        self.done = 0 # Flag to indicate if all samples are collected
        self.step_count = 0 # Counter to track number of steps taken
...
def telemetry(sid, data):
    ...
    if data:
        ...
        if np.isfinite(Rover.vel):
            ...
            if Rover.home_pos is None and Rover.pos is not None:
                # Update the home position only at the beginneing.
                Rover.home_pos = Rover.pos.copy()
